...
export const AddProductScreen = ({ navigation, route }: Props) => {
  ...
  // Default theme handles title inside AppHeader, but we use a custom decorated card instead for modern look.
        ...
        <View className="flex-row items-center justify-between relative z-10">
          <View className="flex-1 pr-4">
            <Text className="text-3xl font-poppins-bold text-white">
              {currentProduct ? "Edit Produk" : "Menu Baru"}
            </Text>
            <Text className="font-poppins mt-2 text-sm leading-5 text-white/80">
              Lengkapi detail di bawah untuk memperbarui katalog tokomu hingga
              tampil di layar kasir.
            </Text>
          </View>
